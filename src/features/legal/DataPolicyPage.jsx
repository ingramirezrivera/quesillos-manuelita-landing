          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div>
              ...
              <p className="text-slate-200 mt-3 max-w-3xl">
                En Quesillos Manuelita S.A.S. protegemos tu información
                personal. Esta política explica cómo recolectamos, usamos y
                protegemos tus datos, incluyendo su uso para analítica digital y
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 md:py-14">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <article className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed">
              Podemos recolectar datos como nombre, teléfono, correo
              electrónico, ciudad, mensajes enviados y datos técnicos de
              navegación.
            </p>
          </article>
          ...
          <article className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <ul className="text-slate-600 leading-relaxed list-disc pl-5 space-y-1">
              ...
              <li>Realizar analítica para optimizar campañas y contenido.</li>
          ...
          <article className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            <h2 className="text-xl font-bold text-slate-900 mb-3">
              4. Base de autorización
            </h2>
            <p className="text-slate-600 leading-relaxed">
              El tratamiento se realiza con tu autorización previa, expresa e
          ...
          <article className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              accidental, se gestionará su eliminación en el menor tiempo
              razonable.
            </p>
          </article>
          ...
          <article className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed">
              Algunos datos de navegación pueden ser procesados por plataformas
              de analítica y publicidad digital. No comercializamos bases de
              datos personales.
            </p>
          </article>
          ...
          <article className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm md:col-span-2">
            ...
            <ul className="text-slate-600 leading-relaxed list-disc pl-5 space-y-1">
              ...
              <li>Revocar autorización y solicitar supresión cuando aplique.</li>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <p className="text-slate-600 leading-relaxed mt-3">
            Atenderemos consultas en máximo diez (10) días hábiles y reclamos
            en máximo quince (15) días hábiles, conforme a la normativa
            colombiana vigente.
          </p>
        </div>
        ...
        <div className="mt-6 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <p className="text-slate-600 leading-relaxed">
            Esta política puede actualizarse por cambios operativos, técnicos o
            regulatorios. La versión vigente será siempre la publicada en este
            sitio web.
          </p>
